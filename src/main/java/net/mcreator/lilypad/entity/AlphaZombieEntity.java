...
import net.mcreator.lilypad.entity.renderer.AlphaZombieRenderer;
import net.mcreator.lilypad.LilypadModElements;

@LilypadModElements.ModElement.Tag
public class AlphaZombieEntity extends LilypadModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("alpha_zombie").setRegistryName("alpha_zombie");

	public AlphaZombieEntity(LilypadModElements instance) {
		super(instance, 52);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AlphaZombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10205363, -8684679, new Item.Properties().group(LilypadExtensionItemGroup.tab))
				.setRegistryName("alpha_zombie_spawn_egg"));
	}
