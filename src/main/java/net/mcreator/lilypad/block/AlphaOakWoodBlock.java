...
public class AlphaOakWoodBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_oak_wood")
	public static final Block block = null;

	public AlphaOakWoodBlock(LilypadModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("alpha_oak_wood");
		}
