...
public class AlphaOakPlanksBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_oak_planks")
	public static final Block block = null;

	public AlphaOakPlanksBlock(LilypadModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("alpha_oak_planks");
		}
