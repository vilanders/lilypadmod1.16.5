...
public class AlphaStoneBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_stone")
	public static final Block block = null;

	public AlphaStoneBlock(LilypadModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AlphaCobblestoneBlock.block));
		}
	}
}
