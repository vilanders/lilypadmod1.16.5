...
public class ObsidianLilyBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:obsidian_lily")
	public static final Block block = null;

	public ObsidianLilyBlock(LilypadModElements instance) {
		super(instance, 30);
	}
