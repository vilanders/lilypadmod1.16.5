...
public class FireLilyBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:fire_lily")
	public static final Block block = null;

	public FireLilyBlock(LilypadModElements instance) {
		super(instance, 28);
	}
