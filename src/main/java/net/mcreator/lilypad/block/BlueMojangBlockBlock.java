...
public class BlueMojangBlockBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:blue_mojang_block")
	public static final Block block = null;

	public BlueMojangBlockBlock(LilypadModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_mojang_block");
		}
