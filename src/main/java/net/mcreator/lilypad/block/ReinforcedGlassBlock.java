...
public class ReinforcedGlassBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:reinforced_glass")
	public static final Block block = null;

	public ReinforcedGlassBlock(LilypadModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(0.3f, 0.3f).setLightLevel(s -> 0)
					.setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("reinforced_glass");
		}
