...
import net.mcreator.lilypad.procedures.OverworldDoorProcedure;
...
public class OverworldIronDoorBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:overworld_iron_door")
	public static final Block block = null;

	public OverworldIronDoorBlock(LilypadModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("overworld_iron_door");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			OverworldDoorProcedure.executeProcedure(Stream
