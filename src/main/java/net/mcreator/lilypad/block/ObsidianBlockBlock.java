...
public class ObsidianBlockBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:obsidian_block")
	public static final Block block = null;

	public ObsidianBlockBlock(LilypadModElements instance) {
		super(instance, 42);
	}
