...
public class AlphaOakPressurePlateBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_oak_pressure_plate")
	public static final Block block = null;

	public AlphaOakPressurePlateBlock(LilypadModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("alpha_oak_pressure_plate");
		}
