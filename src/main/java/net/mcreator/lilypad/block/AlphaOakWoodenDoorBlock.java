...
public class AlphaOakWoodenDoorBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_oak_wooden_door")
	public static final Block block = null;

	public AlphaOakWoodenDoorBlock(LilypadModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("alpha_oak_wooden_door");
		}
