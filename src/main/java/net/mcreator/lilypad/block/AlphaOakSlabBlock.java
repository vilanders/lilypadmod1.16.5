...
public class AlphaOakSlabBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_oak_slab")
	public static final Block block = null;

	public AlphaOakSlabBlock(LilypadModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("alpha_oak_slab");
		}
