...
public class AlphaCobblestoneBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_cobblestone")
	public static final Block block = null;

	public AlphaCobblestoneBlock(LilypadModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("alpha_cobblestone");
		}
