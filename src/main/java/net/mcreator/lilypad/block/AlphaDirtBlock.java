...
public class AlphaDirtBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_dirt")
	public static final Block block = null;

	public AlphaDirtBlock(LilypadModElements instance) {
		super(instance, 2);
	}
