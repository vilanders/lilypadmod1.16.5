...
public class StonePillarBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:stone_pillar")
	public static final Block block = null;

	public StonePillarBlock(LilypadModElements instance) {
		super(instance, 34);
	}
