...
public class AlphaOakFenceGateBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_oak_fence_gate")
	public static final Block block = null;

	public AlphaOakFenceGateBlock(LilypadModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("alpha_oak_fence_gate");
		}
