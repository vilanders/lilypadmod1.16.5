...
public class AlphaOakLogBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_oak_log")
	public static final Block block = null;

	public AlphaOakLogBlock(LilypadModElements instance) {
		super(instance, 16);
	}
