...
public class WhiteMojangBlockBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:white_mojang_block")
	public static final Block block = null;

	public WhiteMojangBlockBlock(LilypadModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_mojang_block");
		}
