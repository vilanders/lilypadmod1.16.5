...
import net.mcreator.lilypad.procedures.LilyInteractionProcedure;
...
public class LilyBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:lily")
	public static final Block block = null;

	public LilyBlock(LilypadModElements instance) {
		super(instance, 27);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lilypad:lily"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SPEED, 100,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
							.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setLightLevel(s -> 4));
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			LilyInteractionProcedure.executeProcedure(Stream
