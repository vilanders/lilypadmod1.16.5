...
public class AlphaCobblestoneSlabBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_cobblestone_slab")
	public static final Block block = null;

	public AlphaCobblestoneSlabBlock(LilypadModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("alpha_cobblestone_slab");
		}
