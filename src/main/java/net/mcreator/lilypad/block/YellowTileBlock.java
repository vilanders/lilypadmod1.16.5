...
public class YellowTileBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:yellow_tile")
	public static final Block block = null;

	public YellowTileBlock(LilypadModElements instance) {
		super(instance, 33);
	}
