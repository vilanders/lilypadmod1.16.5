...
import net.mcreator.lilypad.procedures.ForestDoorProcedure;
import net.mcreator.lilypad.procedures.DimensionWarn2Procedure;
...
public class ForestIronDoorBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:forest_iron_door")
	public static final Block block = null;

	public ForestIronDoorBlock(LilypadModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("forest_iron_door");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			DimensionWarn2Procedure.executeProcedure(Stream
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			ForestDoorProcedure.executeProcedure(Stream
