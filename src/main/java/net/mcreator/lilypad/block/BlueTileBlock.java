...
public class BlueTileBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:blue_tile")
	public static final Block block = null;

	public BlueTileBlock(LilypadModElements instance) {
		super(instance, 32);
	}
