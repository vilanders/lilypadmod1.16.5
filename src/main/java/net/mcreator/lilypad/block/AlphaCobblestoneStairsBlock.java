...
public class AlphaCobblestoneStairsBlock extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:alpha_cobblestone_stairs")
	public static final Block block = null;

	public AlphaCobblestoneStairsBlock(LilypadModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("alpha_cobblestone_stairs");
		}
