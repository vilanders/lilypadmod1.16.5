...
public class SkyFireSpawnStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 250000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("lilypad", "sky_fire"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("sky_fire_spawn"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lilypad:sky_fire_spawn"), configuredFeature);
		}
	}
