...
public class HubDoorOvwStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("hub_door_ovw"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lilypad:hub_door_ovw"), configuredFeature);
		}
	}
