...
import net.mcreator.lilypad.block.AlphaStoneBlock;
...
public class AlphaDimension extends LilypadModElements.ModElement {
	public AlphaDimension(LilypadModElements instance) {
		super(instance, 60);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(AlphaStoneBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("lilypad:alpha_forest")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("lilypad:alpha"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
