...
public class ObsidianHoeItem extends LilypadModElements.ModElement {
	@ObjectHolder("lilypad:obsidian_hoe")
	public static final Item block = null;

	public ObsidianHoeItem(LilypadModElements instance) {
		super(instance, 47);
	}
	...
	public void initElements() {
		...
		}, 0, 0f, new Item.Properties().group(LilypadExtensionItemGroup.tab)) {
